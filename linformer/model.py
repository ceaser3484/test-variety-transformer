...
class LinformerSelfAttention(nn.Module):
    ...
    def forward(self, query, key, value):
        ...
        value = self.value_weight(k_value.permute(0, 2, 1))
        ...
        attention = self.normalization(self.dropout(attention) + origin_sequence)
...
class FeedForwardNetwork(nn.Module):
    ...
    def forward(self, sequence):
        ...
        sequence = self.normalization(self.dropout(sequence) + origin_sequence)
        return sequence
